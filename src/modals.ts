...
export class FolderRenameWarningModal extends Modal {
	...
	onOpen() {
		...
		contentEl.createEl("h3", {
			text: this.isRecursive
				? "This operation will scan all files in the foler and subfolders, and rename the attachments in them."
				: "This operation will scan all files in the foler and rename the attachments in them.",
		});
		contentEl.createEl("h3", {
